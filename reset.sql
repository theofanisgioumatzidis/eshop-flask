...
VALUES 
    ('True', 'Smartphones', 'iPhone 15 5G (6GB/128GB)', 'apple', 799.00,
    ...
    ('True', 'Laptops', 'Lenovo ThinkPad P16v Gen 2 (Intel) 16', 'Lenovo', 3063.00,
        'If you want a workstation thats great performance but light and thin at the same time, the Thinkpad P16v Gen2 is the perfect laptop for you.',
    ...
    ('True', 'Smartphones', 'Google Pixel 9 Pro XL 5G', 'Google', 1140.00,
        'The Pixel 9 Pro XLs overhead new design features a silky matte glass back, a beautiful double-finished camera bar, and a polished metal frame thats as good as it looks.',
